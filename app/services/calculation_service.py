...
class CalculationService:
    ...
    def calculate_wallet_data(self, address):
        ...
        roa = ((balance_usd + returned_usd - invested_usd) / invested_usd * 100) if invested_usd > 0 else 0
    ...
    def update_wallet(self, wallet):
        ...
        if has_new:
            ...
            _, _processed_txs_listed_only_for_roa_calc_needed_here_if_not_stored_elsewhere_=_self.calculate_wallet_data(wallet.address)
            _, _processed_txs_listed_only_for_roa_calc_needed_here_if_not_stored_elsewhere_=_self.calculate_wallet_data(wallet.address)
